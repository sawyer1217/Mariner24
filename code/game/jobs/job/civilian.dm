...
/datum/job/lawyer
	...
	equip(var/mob/living/carbon/human/H)
		...
		L.imp_in = H
		L.implanted = 1
		H << "As an Internal Affairs Agent, you are the proud owner of a Loyalty implant. Read more about them <a href=http://http://baystation12.net/wiki/index.php?title=Security_Items#Loyalty_Implant>here</a>"
